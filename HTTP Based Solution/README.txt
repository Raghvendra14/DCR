...
2) Please keep in mind that it's a HTTP Server and you'd need to perform all actions seperately in different tabs or browsers for concurrent processing. (Except Kill Connection functionality)
